    ...
    <Card className="w-full max-w-2xl border-2 border-primary/50 shadow-xl bg-gradient-to-br from-background to-secondary/30">
        <CardContent className="p-8 relative">
            ...
            <div className="text-center my-8">
                <h2 className="text-3xl font-headline font-semibold tracking-wider uppercase">Certificate of Scholarship Application</h2>
            ...
            <p className="text-center text-lg text-foreground/80 leading-relaxed">
                For successfully applying for the <strong>{data.exam}</strong> scholarship plan.
